...
const Footer = () => {
  ...
  return (
    <footer className="bg-black mt-24 text-gray-300 py-8 px-6 w-full">
      <div className="w-full max-w-none mx-auto">
        ...
        <div className="block md:hidden">
          ...
          {/* Theme Selector */}
          <div className="mb-6">
            <h3 className="text-white font-medium mb-3 text-sm">Theme</h3>
            <div className="flex items-center gap-1  rounded-md p-1 w-fit">
              <button
                onClick={() => toggleTheme('dark')}
                className={`p-1.5 rounded transition-colors ${theme === 'dark' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-white'}`}
              >
                <Moon size={14} />
              </button>
              <button
                onClick={() => toggleTheme('light')}
                className={`p-1.5 rounded transition-colors ${theme === 'light' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-white'}`}
              >
                <Sun size={14} />
              </button>
              <button
                onClick={() => toggleTheme('system')}
                className={`p-1.5 rounded transition-colors ${theme === 'system' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-white'}`}
              >
                <Monitor size={14} />
              </button>
            </div>
        ...
        <div className="hidden md:grid grid-cols-8 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">DX Platform</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Infrastructure</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Storage</a></li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Turbo</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Enterprise</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">CLI & API</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Docs</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Pricing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Customers</a></li>
          ...
          {/* Experts Column */}
          <div className="md:col-span-1">
            <h3 className="text-white font-medium mb-4">Experts</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Guides</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Help</a></li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors flex items-center gap-1">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Open Source</a></li>
